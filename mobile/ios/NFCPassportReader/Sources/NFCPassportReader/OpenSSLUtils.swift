...
public class OpenSSLUtils {
    ...
    public static func computeSharedSecret( privateKeyPair: OpaquePointer, publicKey: OpaquePointer ) -> [UInt8] {
        ...
        if keyType == EVP_PKEY_DH || keyType == EVP_PKEY_DHX {
            ...
            _ = DH_compute_key(&secret, bn, dh)
            
            Logger.openSSL.debug("OpenSSLUtils.computeSharedSecret - DH secret derived")
        } else {
            ...
            Logger.openSSL.debug("OpenSSLUtils.computeSharedSecret - ECDH secret derived")
